...
export default function EditorComponent() {
  ...
  return (
    <div className="flex">
      ...
      />
      <div className="flex-1 ml-16 h-screen dark:bg-slate-900 rounded-r-2xl shadow-2xl py-6 px-8">
        {/* EDITOR HEADER */}
        <div className="flex items-center justify-between pb-3">
          <h2 className="scroll-m-20 text-2xl font-semibold tracking-tight first:mt-0">
            main.{getFileExtension(languageOption.language)}
          </h2>
        ...
        {/* EDITOR  */}
        <div className="bg-slate-400 dark:bg-slate-950 rounded-2xl h-[calc(100vh-120px)]">
          <ResizablePanelGroup
            direction="horizontal"
            className="h-full w-full rounded-lg border dark:bg-slate-900"
          >
            ...
            <ResizablePanel defaultSize={50} minSize={35}>
              {/* Header */}
              <div className="space-y-3 bg-slate-300 dark:bg-slate-900 h-full">
